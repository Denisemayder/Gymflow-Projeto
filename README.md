...
5. Preencher em .env os valores das constantes de ambiente que faltam. Ex: usuário, senha, segredos

6. docker compose up --build

7. migrations : docker compose run --rm cli node backend/command.js migrate
